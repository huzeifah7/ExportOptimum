    ...
    <AnimatedGradientBackground>
        ...
        <main className="flex-grow">
            ...
            <motion.section 
                ...
                variants={containerVariants}
            >
                <div className="container mx-auto px-4 grid lg:grid-cols-2 gap-10 xl:gap-16 items-start">
                     {/* FAQ */}
                    <motion.div variants={itemVariants}>
                        <h2 className="text-3xl font-bold font-headline mb-8 text-foreground">Frequently Asked Questions</h2>
                        <Accordion type="single" collapsible className="w-full bg-background/30 p-4 rounded-2xl border border-border/10">
