...
const cardData: BentoCardProps[] = [
  {
    icon: <Image src="/avo4.png" alt="Freshness" width={40} height={40} className="w-10 h-10 object-contain" />,
    title: 'Freshness',
    description: 'An unbroken cold chain and rapid logistics ensure produce arrives as fresh as the day it was picked.',
    label: 'Pillar 1'
  },
  {
    icon: <Image src="/avo6.png" alt="Hygiene & Safety" width={40} height={40} className="w-10 h-10 object-contain" />,
    title: 'Hygiene & Safety',
    description: 'We adhere to strict international hygiene protocols at every stage, from handling to packing.',
    label: 'Pillar 2'
  },
  {
    icon: <Image src="/avo3.png" alt="Traceability" width={40} height={40} className="w-10 h-10 object-contain" />,
    title: 'Traceability',
    description: 'Every batch is fully traceable, providing complete transparency from our orchards to your facility.',
    label: 'Pillar 3'
  },
   {
    icon: <Image src="/avo3.png" alt="Sustainability" width={40} height={40} className="w-10 h-10 object-contain" />,
