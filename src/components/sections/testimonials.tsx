    ...
    <section id="testimonials" className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground font-subtitle text-4xl">We pride ourselves on building lasting relationships based on trust and quality.</p>
        </div>
