    ...
    <section id="partners" className="py-16 lg:py-24 bg-secondary">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground font-subtitle text-[2.75rem]">We collaborate with leading companies in the global food industry.</p>
        </div>
