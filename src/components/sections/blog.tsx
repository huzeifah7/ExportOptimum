    ...
    <section id="blog" className="py-16 lg:py-24 bg-background">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground font-subtitle text-[33px] tracking-wide">Insights, news, and stories from the world of avocados.</p>
        </div>
