    ...
    <section id="varieties" className="py-16 lg:py-24 bg-[#f9fafb] relative">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground font-subtitle text-[33px] tracking-wide">We cultivate and export several premium varieties to meet global demand.</p>
        </div>
        <Carousel 
          opts={{
            align: "start",
